const array_productos = [
    {id:1, tipo:"Bebidas", categoria:"Refrescos", nombre:"A&W Cream Soda", descripcion:"Lata - 355 ml", precio:80, imagen:""},
    {id:2, tipo:"Bebidas",  categoria:"Refrescos", nombre:"A&W Root Beer", descripcion:"Lata - 355 ml", precio:80, imagen:""},
    {id:3, tipo:"Bebidas",  categoria:"Refrescos", nombre:"Coca Cola Original", descripcion:"Lata - 355 ml", precio:40, imagen:""},
    {id:4, tipo:"Bebidas",  categoria:"Refrescos", nombre:"Snapple Limón Light", descripcion:"Botella - 473 ml", precio:40, imagen:""},
    {id:5, tipo:"Bebidas", categoria:"Refrescos", nombre:"Boing Mango", descripcion:"Botella - 355 ml", precio:35, imagen:""},
    {id:6, tipo:"Bebidas",  categoria:"Refrescos", nombre:"Sidral Mundet", descripcion:"Lata - 355 ml", precio:35, imagen:""},
    {id:7, tipo:"Bebidas",  categoria:"Refrescos", nombre:"Agua Mineral Peñafiel", descripcion:"Lata - 355 ml", precio:30, imagen:""},
    ...
    {id:13, tipo:"Bebidas",  categoria:"Cervezas", nombre:"Heineken", descripcion:"355 ml", precio:65, imagen:""},
    {id:14, tipo:"Bebidas",  categoria:"Cervezas", nombre:"Bohemia Vienna", descripcion:"355 ml", precio:55, imagen:""},
    {id:15, tipo:"Bebidas",  categoria:"Cervezas", nombre:"Nochebuena", descripcion:"355 ml", precio:60, imagen:""},
    {id:16, tipo:"Bebidas",  categoria:"Cervezas", nombre:"Ticus Porter", descripcion:"355 ml", precio:140, imagen:""},
    {id:17, tipo:"Bebidas",  categoria:"Bebibas Alcohólicas", nombre:"Ron Bacardi Blanco", descripcion:"Copa 2 oz", precio:50, imagen:""},
    {id:18, tipo:"Bebidas",  categoria:"Bebibas Alcohólicas", nombre:"Ron Abuelo", descripcion:"Copa 2 oz", precio:60, imagen:""},
    {id:19, tipo:"Bebidas",  categoria:"Bebibas Alcohólicas", nombre:"Whiskey Jack Daniel's 7", descripcion:"Copa 2 oz", precio:125, imagen:""},
    {id:20, tipo:"Bebidas",  categoria:"Bebibas Alcohólicas", nombre:"Mezcal 400 conejos", descripcion:"Copa 2 oz", precio:160, imagen:""},
    {id:21, tipo:"Bebidas",  categoria:"Bebibas Alcohólicas", nombre:"Gin Bombay Sapphire", descripcion:"Copa 2 oz", precio:140, imagen:""},
    {id:22, tipo:"Bebidas",  categoria:"Bebibas Alcohólicas", nombre:"Tequila 1800 Reposado", descripcion:"Copa 2 oz", precio:150, imagen:""},
